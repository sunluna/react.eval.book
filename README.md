...
作者受 easyui\([http://www.jeasyui.com\](http://www.jeasyui.com%29\) 的理念影响, 认为 组件应当 为 程序员 服务，极少的配置获取尽可能多的功能。组件存在的目的是为了通过封装组合，尽最大可能不出bug，让经验得以积累，提高效率。

dva和redux翻倍的代码量本身就是制造bug的根源。jquery，vue这些经典的东西本身的生存哲学依然有可取之处。

react.eval 的执行方式就是仿照easyui来的。
